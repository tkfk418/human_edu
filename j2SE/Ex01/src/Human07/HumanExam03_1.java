...
public class HumanExam03_1 {
	...
	public static void main(String[] args) {
		...
		//배열의 초기화 방법
		int [] human1 = {10,20,30};	//첫번째 방법
		System.out.println("human1[0]=" +human1[0]);
		
		// 두번째 방법
		int [] human2 = new int [2];
		human2[0] = 10;
		human2[1] = 20;
		System.out.println("human2[0]=" +human2[0]);
		
		//세번째 방법  ==>두번째 방법의 응용. 반복문 활용
		int [] human3 = new int [3];
		for (int a=0; a<human3.length; a++) {
			
			human3[a] = (a+1)*10;
		}
		System.out.println("human3[2]=" +human3[2]);
