...
public class DateTimeInfoExam {
	...
	public static void main(String[] args) {
		...
		System.out.println(now.toString());
				...
				System.out.println("서울에 대한 zone id: "+seoulZoneId);
				ZoneOffset soeoulZoneOffset = seoulDateTime.getOffset();
				System.out.println("서울은 기준시로부터 얼마나 차이가 있는가" +soeoulZoneOffset+"시간" );
