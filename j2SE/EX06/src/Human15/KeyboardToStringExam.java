...
public class KeyboardToStringExam {
	...
	public static void main(String[] args) throws IOException {
		...
		//System.in.read : 키보드에서 입력한 글자를 바이트의 배열변수(b)에 담는 기능을 수행
		...
		//영문은 한글자당 1바이트 단위로 처리가 되는데 영문외에는 한글자당 2~3바이트 단위로 처리를 함.
		// 아스키코드는 영문위지이고, UTF-8등등의 다른 코드체계가 생겼는데 이는 다국어 지원을 위한 것임.
