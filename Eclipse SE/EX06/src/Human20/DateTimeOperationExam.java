...
public class DateTimeOperationExam {
	...
	public static void main(String[] args) {
		...
		System.out.println("타겟시간1 " +targetDateTime1.toString());
		...
		System.out.println("올해의 마지막날은?" + targetDateTime5);
		...
		System.out.println("현재시간대비 다음주 월요일의 날짜는?" + targetDateTime10);
		LocalDateTime targetDateTime11=now.with(TemporalAdjusters.previous(DayOfWeek.MONDAY));
		System.out.println("현재시간대비 지난주 월요일의 날짜는?" + targetDateTime11);
